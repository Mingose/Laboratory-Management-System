...
def getdate(Recent_dbname,ID,name,location):
...
def Modleshow(ID,name,location):
    ...
    dlg = showmodlepane()
    view = dlg.mytableview
    getdate(Recent_dbname,ID,name,location)
...
if __name__ == '__main__':
    ...
    # dlg = showmodlepane()   #在界面中显示
    # getdate(Recent_dbname,None,None,None)
